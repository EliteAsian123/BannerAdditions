...
@OnlyIn(Dist.CLIENT)
public class NewBannerTileEntityRenderer extends TileEntityRenderer<NewBannerTileEntity> {
    ...
    public NewBannerTileEntityRenderer(TileEntityRendererDispatcher p_i226002_1_) {
        super(p_i226002_1_);
