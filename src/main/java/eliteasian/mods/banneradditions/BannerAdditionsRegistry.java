...
public final class BannerAdditionsRegistry {
    public static class Blocks {
        ...
        public static final Block WHITE_BANNER = regBanner(new NewBannerBlock(DyeColor.WHITE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "white_banner");
        public static final Block ORANGE_BANNER = regBanner(new NewBannerBlock(DyeColor.ORANGE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "orange_banner");
        public static final Block MAGENTA_BANNER = regBanner(new NewBannerBlock(DyeColor.MAGENTA, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "magenta_banner");
        public static final Block LIGHT_BLUE_BANNER = regBanner(new NewBannerBlock(DyeColor.LIGHT_BLUE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "light_blue_banner");
        public static final Block YELLOW_BANNER = regBanner(new NewBannerBlock(DyeColor.YELLOW, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "yellow_banner");
        public static final Block LIME_BANNER = regBanner(new NewBannerBlock(DyeColor.LIME, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "lime_banner");
        public static final Block PINK_BANNER = regBanner(new NewBannerBlock(DyeColor.PINK, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "pink_banner");
        public static final Block GRAY_BANNER = regBanner(new NewBannerBlock(DyeColor.GRAY, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "gray_banner");
        public static final Block LIGHT_GRAY_BANNER = regBanner(new NewBannerBlock(DyeColor.LIGHT_GRAY, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "light_gray_banner");
        public static final Block CYAN_BANNER = regBanner(new NewBannerBlock(DyeColor.CYAN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "cyan_banner");
        public static final Block PURPLE_BANNER = regBanner(new NewBannerBlock(DyeColor.PURPLE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "purple_banner");
        public static final Block BLUE_BANNER = regBanner(new NewBannerBlock(DyeColor.BLUE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "blue_banner");
        public static final Block BROWN_BANNER = regBanner(new NewBannerBlock(DyeColor.BROWN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "brown_banner");
        public static final Block GREEN_BANNER = regBanner(new NewBannerBlock(DyeColor.GREEN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "green_banner");
        public static final Block RED_BANNER = regBanner(new NewBannerBlock(DyeColor.RED, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "red_banner");
        public static final Block BLACK_BANNER = regBanner(new NewBannerBlock(DyeColor.BLACK, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD)), "black_banner");

        public static final Block WHITE_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.WHITE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(WHITE_BANNER)), "white_wall_banner");
        public static final Block ORANGE_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.ORANGE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(ORANGE_BANNER)), "orange_wall_banner");
        public static final Block MAGENTA_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.MAGENTA, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(MAGENTA_BANNER)), "magenta_wall_banner");
        public static final Block LIGHT_BLUE_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.LIGHT_BLUE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(LIGHT_BLUE_BANNER)), "light_blue_wall_banner");
        public static final Block YELLOW_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.YELLOW, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(YELLOW_BANNER)), "yellow_wall_banner");
        public static final Block LIME_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.LIME, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(LIME_BANNER)), "lime_wall_banner");
        public static final Block PINK_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.PINK, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(PINK_BANNER)), "pink_wall_banner");
        public static final Block GRAY_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.GRAY, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(GRAY_BANNER)), "gray_wall_banner");
        public static final Block LIGHT_GRAY_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.LIGHT_GRAY, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(LIGHT_GRAY_BANNER)), "light_gray_wall_banner");
        public static final Block CYAN_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.CYAN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(CYAN_BANNER)), "cyan_wall_banner");
        public static final Block PURPLE_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.PURPLE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(PURPLE_BANNER)), "purple_wall_banner");
        public static final Block BLUE_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.BLUE, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(BLUE_BANNER)), "blue_wall_banner");
        public static final Block BROWN_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.BROWN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(BROWN_BANNER)), "brown_wall_banner");
        public static final Block GREEN_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.GREEN, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(GREEN_BANNER)), "green_wall_banner");
        public static final Block RED_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.RED, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(RED_BANNER)), "red_wall_banner");
        public static final Block BLACK_WALL_BANNER = regBanner(new NewWallBannerBlock(DyeColor.BLACK, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(BLACK_BANNER)), "black_wall_banner");
